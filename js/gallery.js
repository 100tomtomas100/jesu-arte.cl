const gallery = (() => {
    ...
    let tiltClose =(() => {
        ...
        function tiltLandscape(e) {
            if (e.matches && '(orientation: landscape)' && enlargenedLarge === true) {               
                minimize();  
            } else {
        ...
        function tiltPortrait(e) {
            if (e.matches && '(orientation: portrait)' && enlargenedLarge === true) {               
                minimize();
            } else {                       
                closeEnlargen.closeFun();
            }        
