...
const expandNavBar = (() => {   
    let buttons = document.querySelector(".navbar-mobile-buttons"); 
    let expand = document.querySelector(".burger-menu").addEventListener("click", () => {
    ...
    window.onscroll = () => {
      ...
      if (window.scrollY > 0 
        ...
        && window.innerWidth < 481) {
          document.querySelector(".navbar-mobile-buttons").style.display = "none";
      }  
    }; 
})();
